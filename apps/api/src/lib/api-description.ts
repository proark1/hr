...
export const apiDescription = [
  ...
  "## Webhooks (preview)",
  "",
  "MyHR will fire HTTPS webhooks to a per-org delivery URL when employee data changes (`employee.created`, `employee.updated`, `employee.deleted`) and when documents approach expiry (`document.expiring`). Event payloads are documented under the **Webhooks** section of the spec. Delivery, signing (`Webhook-Signature` header, HMAC-SHA256), and retry semantics ship in a follow-up release.",
  "",
  "## Quickstart",
  "",
  "```bash",
